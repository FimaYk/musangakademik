...
<body class="fix-menu">
    ...
    <section id="home" class="hero_section gradiant_5 padding">
        <div class="login-card card-block auth-body mr-auto ml-auto">
            <form class="md-float-material" action="proseslogin.php" method="POST">
                <div class="auth-box">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                            <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em; margin-bottom: -1px;">Siakad Musang</h1>
                                <h4 style="font-family: 'Montserrat', sans-serif; font-weight: 500; letter-spacing: -0.05em;">Sistem Informasi Akademik SMA Musang</h4>
                                <h5 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em;">LOGIN ADMIN</h5>
                            </div>
                        </div>
                    </div>
                    <hr>
                    <div class="input-group">
                        ...
                        <input type="text" id="username" name="username" class="form-control" placeholder="Username Anda" required="">
