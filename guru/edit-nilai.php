                                    ...
                                    <div class="page-wrapper" style="padding:1rem">
                                        <div class="card total-request-card">
                                            ...
                                            <div class="card-block">
                                                <?php
                                                $query = $conn->query("SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, guru.nama_guru, kelas.nama_kelas FROM nilai
                                                ...
                                                <form class="form-horizontal style-form" action="update-nilai.php" method="post" name="form1" id="form1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_pelajaran" id="kode_pelajaran" class="form-control" readonly>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_guru" id="kode_guru" class="form-control" readonly>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_kelas" id="kode_kelas" class="form-control" readonly>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_siswa" id="kode_siswa" class="form-control" readonly>
