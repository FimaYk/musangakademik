                                            ...
                                            <div class="card-block">
                                                <form class="form-horizontal style-form" action="insert-nilai.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_guru" id="kode_guru" class="form-control" disabled>
                                                                <?php
                                                                $nama = $_SESSION['nama'];
                                                                $query = $conn->query("SELECT * FROM guru WHERE nama_guru='$nama'");
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_pelajaran" id="kode_pelajaran" class="form-control" required>
                                                                ...
                                                                <?php
                                                                $sql = $conn->query("SELECT * FROM pelajaran ORDER BY kode_pelajaran ASC");
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_kelas" id="kode_kelas" class="form-control" required>
                                                                <option> ---- Pilih Salah Satu ---- </option>
                                                                <?php
                                                                $sql = $conn->query("SELECT * FROM kelas ORDER BY tahun_ajar ASC");
                                                                while ($data = $sql->fetch_assoc()) {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="kode_siswa" id="kode_siswa" class="form-control" required>
                                                                <option> ---- Pilih Salah Satu ---- </option>
                                                                <?php
                                                                $sql = $conn->query("SELECT siswa.* FROM siswa, kelas_siswa WHERE siswa.kode_siswa = kelas_siswa.kode_siswa ORDER BY nama_siswa");
                                                                while ($data = $sql->fetch_assoc()) {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nilai_tugas1" id="nilai_tugas1" placeholder="Nilai Tugas 1" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nilai_tugas2" id="nilai_tugas2" placeholder="Nilai Tugas 2" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nilai_uts" id="nilai_uts" placeholder="Nilai UTS" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nilai_uas" id="nilai_uas" placeholder="Nilai UAS" class="form-control" required />
                                                        </div>
                                                    </div>
