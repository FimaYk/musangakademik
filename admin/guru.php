                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-10">
                                                            ...
                                                            <a href='guru' class="btn btn-sm btn-success">Refresh</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <?php while ($data = $tampil->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <center>
                                                                <a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit Guru" href="edit-guru.php?hal=edit-admin&kd=<?php echo $data['kode_guru']; ?>"><span class="icofont-edit"></span></a>
                                                                <hr />
                                                                <a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Guru" href="hapus-guru.php?hal=hapus&kd=<?php echo $data['kode_guru']; ?>"><span class="icofont-trash"></span></a>
                                                            </center>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
