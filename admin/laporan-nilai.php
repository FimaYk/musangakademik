                    ...
                    <div class="main-body">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-10">
                                                    ...
                                                    <a href='laporan-nilai' class="btn btn-sm btn-success">Refresh</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Laporan Nilai Siswa</h5>
                            </div>
                            <div class="card-block table-border-style">
                                <div class="button-panel" style="padding: 0px 20px 10px 20px; float:left">
                                    <a class="btn btn-primary btn-bordered btn-mini pull-right" href="nilai_pdf.php">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $query1 = "SELECT nilai.*, pelajaran.nama_pelajaran, siswa.nama_siswa, siswa.nis, kelas_siswa.jurusan FROM nilai
                                    ...
                                    if (isset($_POST['qcari'])) {
                                        $qcari = $_POST['qcari'];
                                        $query1 .= " WHERE kelas_siswa.kode_kelas LIKE ? OR siswa.nama_siswa LIKE ?";
                                    }
                                        ...
                                        <tbody>
                                            ...
                                            while ($myData = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Print Nilai" href="cetak-nilai.php?hal=edit-admin&kd=<?php echo $myData['id']; ?>">
                                                                <span class="icofont-print"></span>
                                                            </a>
                                                        </center>
                                                    </td>
                                                </tr>
