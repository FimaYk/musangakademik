                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="kode_kelas" id="kode_kelas" class="form-control" required>
                                                        ...
                                                        <?php
                                                        $eskiel = $conn->query("SELECT * FROM kelas ORDER BY kode_kelas ASC");
                                                        if ($eskiel->num_rows != 0) {
                                                            while ($dataku = $eskiel->fetch_assoc()) {
                                                                echo '<option value="' . htmlspecialchars($dataku['kode_kelas']) . '">' . htmlspecialchars($dataku['nama_kelas']) . '</option>';
                                                            }
                                                        }
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="kode_siswa" id="kode_siswa" class="form-control" required>
                                                        <option> ---- Pilih Salah Satu ---- </option>
                                                        <?php
                                                        $sql = $conn->query("SELECT * FROM siswa ORDER BY kode_siswa ASC");
                                                        if ($sql->num_rows != 0) {
                                                            while ($data = $sql->fetch_assoc()) {
                                                                echo '<option value="' . htmlspecialchars($data['kode_siswa']) . '">' . htmlspecialchars($data['nama_siswa']) . '</option>';
                                                            }
                                                        }
                                                        ?>
                                                    </select>
