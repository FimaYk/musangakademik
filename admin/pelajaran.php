                                            ...
                                            <div class="col-xs-12 col-sm-6">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-10">
                                                        ...
                                                        <a href='pelajaran.php' class="btn btn-sm btn-success">Refresh</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block table-border-style">
                                    <div class="button-panel" style="padding: 0px 20px 10px 20px; float:left">
                                        <a class="btn btn-primary btn-bordered btn-mini pull-right" href="input-pelajaran.php">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        if (isset($_POST['qcari'])) {
                                            $qcari = $_POST['qcari'];
                                            $query1 = "SELECT * FROM pelajaran 
                                                       WHERE kode_pelajaran LIKE ? OR nama_pelajaran LIKE ?";
                                        ...
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                <?php while ($data = $result->fetch_assoc()) { ?>
                                                    <tr>
                                                        <td style="min-width:80px;white-space: inherit"><?php echo htmlspecialchars($data['kode_pelajaran']); ?></td>
                                                        <td style="min-width:80px;white-space: inherit"><?php echo htmlspecialchars($data['nama_pelajaran']); ?></td>
                                                        <td style="min-width:80px;white-space: inherit"><?php echo htmlspecialchars($data['keterangan']); ?></td>
                                                        <td style="min-width:80px;white-space: inherit">
                                                            <center>
                                                                <a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit Pelajaran" href="edit-pelajaran.php?hal=edit-admin&kd=<?php echo htmlspecialchars($data['kode_pelajaran']); ?>">
                                                                    <span class="icofont-edit"></span>
                                                                </a>
                                                                <hr />
                                                                <a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Pelajaran" href="hapus-pelajaran.php?hal=hapus&kd=<?php echo htmlspecialchars($data['kode_pelajaran']); ?>" onclick="return confirm('Apakah anda akan menghapus <?php echo htmlspecialchars($data['kode_pelajaran']); ?> ?');">
