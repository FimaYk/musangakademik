                                ...
                                <div class="page-wrapper" style="padding:1rem">
                                    <div class="card total-request-card">
                                        ...
                                        <div class="card-block">
                                            <?php
                                            $query = $conn->query("SELECT * FROM nilai WHERE id='$_GET[kd]'");
                                            ...
                                            <form class="form-horizontal style-form" action="update-nilai.php" method="post" name="form1" id="form1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="kode_pelajaran" id="kode_pelajaran" value="<?php echo $data['kode_pelajaran']; ?>" class="form-control" readonly />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Guru Pengajar</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="kode_guru" id="kode_guru" value="<?php echo $data['kode_guru']; ?>" class="form-control" readonly />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="kode_kelas" id="kode_kelas" value="<?php echo $data['kode_kelas']; ?>" class="form-control" readonly />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Nama Siswa</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="kode_siswa" id="kode_siswa" value="<?php echo $data['kode_siswa']; ?>" class="form-control" readonly />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nilai_tugas1" id="nilai_tugas1" value="<?php echo $data['nilai_tugas1']; ?>" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Nilai Tugas 2</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nilai_tugas2" id="nilai_tugas2" value="<?php echo $data['nilai_tugas2']; ?>" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Nilai UTS</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nilai_uts" id="nilai_uts" value="<?php echo $data['nilai_uts']; ?>" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Nilai UAS</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="nilai_uas" id="nilai_uas" value="<?php echo $data['nilai_uas']; ?>" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="keterangan" id="keterangan" value="<?php echo $data['keterangan']; ?>" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="form-group">
