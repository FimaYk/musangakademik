...
<head>
    ...
    <link rel="icon" href="../assets/images/favicon.png" type="image/png"> <!-- Use a local favicon -->
                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-10">
                                                            ...
                                                            <a href='admin' class="btn btn-sm btn-success">Refresh</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <?php while ($data = $tampil->fetch_assoc()) { ?>
                                                    <tr>
                                                        ...
                                                        <td style="min-width:80px; white-space: inherit">
                                                            <img src="<?php echo $data['gambar']; ?>" class="img-circle" width="60" style="border: 3px solid orange;" />
                                                        </td>
                                                        <td>
                                                            <center>
                                                                <a class="btn btn-sm btn-primary tooltips" data-placement="bottom" data-original-title="Edit Admin" href="edit-admin.php?hal=edit-admin&kd=<?php echo $data['user_id']; ?>">
                                                                    <span class="icofont-edit"></span>
                                                                </a>
                                                                <hr />
                                                                <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Admin" href="hapus-admin.php?hal=hapus&kd=<?php echo $data['user_id']; ?>">
