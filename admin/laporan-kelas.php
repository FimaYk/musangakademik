                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="row">
                                                <div class="col-xs-12 col-md-10">
                                                    ...
                                                    <a href='laporan-kelas' class="btn btn-sm btn-success">Refresh</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-block table-border-style">
                                <div class="button-panel" style="padding: 0px 20px 10px 20px; float:left">
                                    <a class="btn btn-primary btn-bordered btn-mini pull-right" href="kelas_pdf.php">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['qcari'])) {
                                        ...
                                        $query1 = "SELECT kelas.*, guru.nama_guru FROM kelas
                                                    LEFT JOIN guru ON kelas.kode_guru = guru.kode_guru 
                                                    WHERE kelas.kode_kelas LIKE ? OR kelas.kelas LIKE ?";
                                    }
