                                                ...
                                                <div class="col-xs-12 col-sm-6">
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-10">
                                                            ...
                                                            <a href='data-siswa' class="btn btn-sm btn-success">Refresh</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-block table-border-style">
                                        <div class="table-responsive">
                                            ...
                                            if (isset($_POST['qcari'])) {
                                                $qcari = $_POST['qcari'];
                                                $query1 = "SELECT * FROM siswa WHERE kode_siswa LIKE ? OR nama_siswa LIKE ?";
                                            }
                                                ...
                                                <tbody>
                                                    <?php while ($data = $result->fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td style="min-width:80px;white-space: inherit"><?php echo htmlspecialchars($data['tahun_angkatan']); ?></td>
